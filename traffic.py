...
constant = Constant(500, 0.01, 1, 0.01)
...
p = figure(plot_width=600, plot_height=400, x_axis_label='Araival Traffic (mb/s)', y_axis_label='Cost ($)', tooltips=TOOLTIPS)
...
# p.line(traffic_list, fogCostFixed, legend="Fog Cost", line_width=2, line_color="orange")
